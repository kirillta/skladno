...
| Publishing preview | Plain-text preparation, profile selection, character count, copy-ready preview | Implemented | `PublishingPreviewView` and publishing helpers; direct publishing is not performed. |
