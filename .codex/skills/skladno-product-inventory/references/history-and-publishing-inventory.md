...
| Translations | Source Article/Revision linkage, stale warning, explicit linked translation creation | Implemented | `TranslationsView` and workspace editorial-result state; translation freshness is tied to its own source Revision and Articles remain independently recoverable. |
