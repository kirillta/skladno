...
| Editorial Assistant Panel | Advisory workflow stage selector | Implemented | Article metadata; selecting a Stage never sends AI work, changes Draft text, or creates a Revision. |
