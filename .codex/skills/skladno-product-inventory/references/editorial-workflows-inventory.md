...
| Editorial operations | Fact-check request | Implemented | LangGraph fact-check workflow; findings are advisory and Revision-tied. |
| Editorial operations | Style review | Implemented | Style-aware editorial engine; raw style samples remain local. |
