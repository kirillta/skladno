...
| AI model selection | Refreshed model list, default model, skill-specific overrides | Implemented | Settings route/repository and editorial resolution; six built-in skills are configurable and the model list is refreshed but not persisted. |
