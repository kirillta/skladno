...
export interface EditorialWorkspaceClient extends ApplicationClient, ArticleLibraryClient, EditorialClient, FactCheckClient, StyleCorpusClient, PublishingClient, ApplicationSettingsClient { }
