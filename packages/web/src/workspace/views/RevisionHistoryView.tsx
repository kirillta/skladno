...
export function RevisionHistoryView({ revisions, currentRevisionId, select, generalSettings = defaultGeneralSettings }: {
    ...
    const formatRevisionDate = (createdAt: string) => formatDateTime(createdAt, generalSettings.interfaceLocale, generalSettings.dateFormat, generalSettings.timeFormat);
