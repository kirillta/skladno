...
export function AiSettingsSection({ settings, preferences, models, connectionName, environmentName, connectionError, setConnectionName, setEnvironmentName, onAddConnection, onSetActiveConnection, onRequestConnectionRemoval, onRefreshModels, savePreferences }: {
    ...
    return <>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.defaultModel" })} hint={intl.formatMessage({ id: "settings.defaultModelHint" })}>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.textGenerationModel" })} hint={intl.formatMessage({ id: "settings.textGenerationModelHint" })}>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.specificModels" })} hint={intl.formatMessage({ id: "settings.specificModelsHint" })}>
