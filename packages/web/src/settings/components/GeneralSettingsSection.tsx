...
export function GeneralSettingsSection({ general, save, applyTheme }: { general: GeneralSettings; save: (next: GeneralSettings) => Promise<void>; applyTheme?: (theme: GeneralSettings["theme"]) => void }) {
    ...
    return <>
        <SettingRow label={intl.formatMessage({ id: "settings.preferredAppearance" })} hint={intl.formatMessage({ id: "settings.appearanceHint" })} action={<Button variant="quiet" onClick={() => applyTheme?.(general.theme)}>{intl.formatMessage({ id: "settings.applyAppearance" })}</Button>}>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.interfaceLanguage" })} hint={intl.formatMessage({ id: "settings.interfaceLanguageHint" })}>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.dateFormat" })} hint={intl.formatMessage({ id: "settings.dateFormatHint" })} action={<Button variant="quiet" disabled={general.dateFormat === "system"} onClick={() => void save({ ...general, dateFormat: "system" })}>{intl.formatMessage({ id: "settings.resetDateFormat" })}</Button>}>
        ...
        <SettingRow label={intl.formatMessage({ id: "settings.timeZone" })} hint={intl.formatMessage({ id: "settings.timeZoneHint" })} action={<Button variant="quiet" disabled={general.timeZone === "system"} onClick={() => void save({ ...general, timeZone: "system" })}>{intl.formatMessage({ id: "settings.resetTimeZone" })}</Button>}>
