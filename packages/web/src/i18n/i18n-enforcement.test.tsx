...
function PseudoLocaleFixture() {
    return <IntlProvider locale="en-XA" messages={pseudoMessages} onError={(error) => {
        ...
        <ArticleStatusBar revisionNumber={1} length={{ count: 12, remaining: 2988, state: "within-limit" }} profile={publishLimitProfiles[1]!} customProfiles={[]} setProfile={vi.fn()} copyMarkdown={vi.fn()} copyPlainText={vi.fn()} />
