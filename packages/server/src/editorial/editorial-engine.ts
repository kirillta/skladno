import type { EditorialOperation, StyleProfile, StyleReview } from "@skladno/shared";
...
export type EditorialEngineEvent =
    ...
    | { type: typeof EDITORIAL_ENGINE_EVENT.COMPLETED; responseId: string; text: string; styleReview?: StyleReview };
