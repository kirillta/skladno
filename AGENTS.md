...
5. For broad exploration, TypeScript or TSX work, or a second verification loop, follow the [context-efficient agent-work guide](docs/development/guides/context-efficient-agent-work.md).
